...
public class ViewMatchesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (loggedInUserId != -1) {
            ...
            repository.getUserInfoByUserId(match.getUserId1()).observe(this, userInfo -> {
                if (userInfo != null) {
        ...
        //binding.viewMatchesBackButton.setOnClickListener(v -> {
        //    onBackPressed();
        //});
    //}
    ...
    static Intent viewMatchesIntentFactory(Context context) {
            ...
            intent.putExtra(USER_MATCHES_ACTIVITY_USER_ID, userId);
            return intent;
        }
    }
}